...
The full user journey E2E test validates the complete happy-path flow from campaign discovery to reward redemption, ensuring all critical integration points work correctly.
...
- *Note: Contract interaction required for full test*
...
- *Note: Requires deployed testnet contracts*
...
- *Note: Contract interaction required*
...
- *Note: Requires redemption reserve funding*
