# Trivela Demo Video Script

**Duration**: 4 minutes 30 seconds  
**Target**: Grant reviewers, potential integrators, new users
...
## [3:30 - 3:50] Admin Features (Optional)
...
## [3:50 - 4:10] Technical Highlights
...
**Visual**: Trivela logo fade-out

---

## Alternative: Conference/Pitch Version (2 minutes)

For shorter format presentations:

**[0:00-0:10]** Problem in one sentence  
...
- [ ] Hide personal info (wallet addresses in demo mode)
- [ ] Pre-populate forms (no typos during recording)
- [ ] Test all click targets before recording
- [ ] Close unnecessary windows/tabs
- [ ] Disable notifications
- [ ] Use demo data (not real users/campaigns)
...
- [ ] No outdated features shown
- [ ] Voiceover clear and audible
- [ ] Pacing comfortable (not too fast)
- [ ] Transitions smooth
- [ ] CTAs clearly visible
- [ ] File size < 100MB
- [ ] Captions added and reviewed
- [ ] End screen functional (clickable links)
