...
**Goal:** Partition high-volume tables (participants, events, audit logs) for query performance and data archival.
...
- Added `partition_retention` table to track retention policies (90 days for events, 365 for audit logs)
